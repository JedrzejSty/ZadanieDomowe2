...
import com.example.instrukcja4.TaskFragment.OnListFragmentInteractionListener;
import com.example.instrukcja4.tasks.TaskListContent.Task;
...
public class MyTaskRecyclerViewAdapter extends RecyclerView.Adapter<MyTaskRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(picPath != null && !picPath.isEmpty()){
            ...
            holder.mItemImageView.setImageDrawable(context.getResources().getDrawable(R.drawable.img_0));
        }
